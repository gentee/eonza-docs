...
Программа периодически удаляет старые задачи. Вы можете указать количество дней хранения и максимальное количество задач в настройках программы. Если вы хотите защитить задачу от случайного или автоматического удаления, то нажмите на кнопку
с замком у соответствующей задачи.
