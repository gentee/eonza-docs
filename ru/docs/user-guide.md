...
* [**Пакеты**](packages.html) содержит пакеты скриптов для работы с внешними программами, объектами и сервисами.
* [**Планировщик**](scheduler.html) дает возможность запускать скрипты по таймеру или при возникновении событий.
* [**Браузер**](browser.html) содержит скрипты, которые доступны для запуска в Chrome расширении Eonza.
