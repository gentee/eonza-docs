...
## Версия 1.9.0 - 2020/12/26

* Добавлена опция *Скрыть иконку в трее* в **Настройки**.
* Добавлены [Избранные](/ru/docs/scripts.html) скрипты.
* Добавлены Избранные скрипты в иконку системного трея.
* Добавлен опциональный параметр *onlyfiles* в команду *Список файлов*.
* Добавлена командa [Размер директории](/ru/scripts/directory-size.html).
* Добавлена командa [Создать архив](/ru/scripts/create-archive.html).
* Добавлена командa [Распаковать ZIP](/ru/scripts/unpack-zip.html).
* Добавлена командa [Распаковать TAR.GZ](/ru/scripts/unpack-targz.html).

## Версия 1.8.0 - 2020/12/12

* Добавлена иконка в трее с пунктами *Открыть в браузере* и *Выключить* (исключая MacOS).
* Добавлен параметр **Папка** в настройки скриптов.
* Создана папка *Стнадартная библиотека* для встроенных скриптов.
* Если запущен еще один экземпляр Eonza с таким же файлом конфигурации, то в браузере откроется веб-страница с запущенным ранее экземпляром.
* Добавлен параметр **Заголовок** в Настройки.
* Улучшена страница **Завершить работу**.

## Версия 1.7.0 - 2020/12/06
...
* Добавлены команды [Зашифровать файл](/ru/scripts/encrypt-file.html) и [Расшифровать файл](/ru/scripts/decrypt-file.html).
* Добавлен элемент *Пароль* в команду [Форма](/ru/scripts/form.html).
* Добавлены функции *Добавить путь*, *Имя файла* в команду **Установить переменную**.
